...
par(pin=c(480/72,480/72),mar=c(4,4,1.5,1.5), bg="white",mfrow=c(2,2))

#make the first plot
plot(powersub$DateTime, powersub$Global_active_power,type="l",xlab="",ylab="Global Active Power",yaxp=c(0,8,4))
#make the second plot
plot(powersub$DateTime, powersub$Voltage,type="l",xlab="datetime",ylab="Voltage",yaxp=c(234,246,6))
#make the third plot
...
plot(powersub$DateTime, powersub$Global_reactive_power,type="l",xlab="datetime",ylab="Global_reactive_power",ylim=c(0.0,0.5))
